...
index = 1
60.times do
  user = User.create! :username => "John#{index}", :first_name => 'John', :last_name => "poufi #{index}", :email => "john#{index}@gmail.com", :password => 'topsecret', :password_confirmation => 'topsecret'
  index += 1
end
...
20.times do
  ...
  user = User.first
  professional = user.create_professional
